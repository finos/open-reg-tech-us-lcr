...
applyRules : Wholesale -> List RuleFlow
applyRules flow =
    List.concat
        [ applyRule (match_rule_17_section_32_a_5 flow) (RuleFlow "32(a)(5)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_50_section_32_h_1_ii_A flow) (RuleFlow "32(h)(1)(ii)(A)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_54_section_32_h_2 flow) (RuleFlow "32(h)(2)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_56_section_32_h_2 flow) (RuleFlow "32(h)(2)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_61_section_32_h_5 flow) (RuleFlow "32(h)(5)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_66_section_32_j_1_i flow) (RuleFlow "32(j)(1)(i)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_69_section_32_j_1_ii flow) (RuleFlow "32(j)(1)(ii)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_75_section_32_j_1_iv flow) (RuleFlow "32(j)(1)(iv)" flow.maturityAmount (Flow.Wholesale flow))
        , applyRule (match_rule_80_section_32_j_1_vi flow) (RuleFlow "32(j)(1)(vi)" flow.maturityAmount (Flow.Wholesale flow))
        ]
