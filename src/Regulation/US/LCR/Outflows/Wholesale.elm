...
applyRules : FromDate -> Wholesale -> List RuleBalance
applyRules fromDate wholesale =
    List.concat
        [ applyRule (match_rule_17_section_32_a_5 fromDate wholesale) "32(a)(5)" wholesale.maturityAmount
        , applyRule (match_rule_50_section_32_h_1_ii_A fromDate wholesale) "32(h)(1)(ii)(A)" wholesale.maturityAmount

        --, applyRule (match_rule_51_section_32_h_1_ii_B wholesale) "32(h)(1)(ii)(B)" wholesale.maturityAmount
        , applyRule (match_rule_54_section_32_h_2 fromDate wholesale) "32(h)(2)" wholesale.maturityAmount
        , applyRule (match_rule_56_section_32_h_2 fromDate wholesale) "32(h)(2)" wholesale.maturityAmount
        , applyRule (match_rule_61_section_32_h_5 fromDate wholesale) "32(h)(5)" wholesale.maturityAmount
        , applyRule (match_rule_66_section_32_j_1_i fromDate wholesale) "32(j)(1)(i)" wholesale.maturityAmount
        , applyRule (match_rule_69_section_32_j_1_ii fromDate wholesale) "32(j)(1)(ii)" wholesale.maturityAmount
        , applyRule (match_rule_75_section_32_j_1_iv fromDate wholesale) "32(j)(1)(iv)" wholesale.maturityAmount
        , applyRule (match_rule_80_section_32_j_1_vi fromDate wholesale) "32(j)(1)(vi)" wholesale.maturityAmount
        ]


{-| (17) Other Retail Funding (§.32(a)(5))
-}
match_rule_17_section_32_a_5 : FromDate -> Wholesale -> Bool
match_rule_17_section_32_a_5 fromDate wholesale =
...
-}
match_rule_50_section_32_h_1_ii_A : FromDate -> Wholesale -> Bool
match_rule_50_section_32_h_1_ii_A fromDate wholesale =
...
-}
match_rule_54_section_32_h_2 : FromDate -> Wholesale -> Bool
match_rule_54_section_32_h_2 fromDate wholesale =
    List.member wholesale.product [ o_W_9, o_W_10, o_W_17, o_W_18 ]
        -- Maturity Bucket: <= 30 calendar days
        && MaturityBucket.isLessThanOrEqual30Days fromDate wholesale.maturityBucket
        -- Forward Start Amount: NULL
...
-}
match_rule_56_section_32_h_2 : FromDate -> Wholesale -> Bool
match_rule_56_section_32_h_2 fromDate wholesale =
...
-}
match_rule_61_section_32_h_5 : FromDate -> Wholesale -> Bool
match_rule_61_section_32_h_5 fromDate wholesale =
...
-}
match_rule_66_section_32_j_1_i : FromDate -> Wholesale -> Bool
match_rule_66_section_32_j_1_i fromDate wholesale =
...
-}
match_rule_69_section_32_j_1_ii : FromDate -> Wholesale -> Bool
match_rule_69_section_32_j_1_ii fromDate wholesale =
    List.member wholesale.product [ o_W_1, o_W_2, o_W_3, o_W_4, o_W_5, o_W_6, o_W_7 ]
        -- Maturity Bucket: <= 30 calendar days
        && MaturityBucket.isLessThanOrEqual30Days fromDate wholesale.maturityBucket
...
-}
match_rule_75_section_32_j_1_iv : FromDate -> Wholesale -> Bool
match_rule_75_section_32_j_1_iv fromDate wholesale =
    List.member wholesale.product [ o_W_1, o_W_2, o_W_3, o_W_4, o_W_5, o_W_6, o_W_7 ]
        -- Maturity Bucket: <= 30 calendar days
        && MaturityBucket.isLessThanOrEqual30Days fromDate wholesale.maturityBucket
...
-}
match_rule_80_section_32_j_1_vi : FromDate -> Wholesale -> Bool
match_rule_80_section_32_j_1_vi fromDate wholesale =
    List.member wholesale.product [ o_W_1, o_W_2, o_W_3, o_W_4, o_W_5, o_W_6, o_W_7 ]
        -- Maturity Bucket: <= 30 calendar days
        && MaturityBucket.isLessThanOrEqual30Days fromDate wholesale.maturityBucket
