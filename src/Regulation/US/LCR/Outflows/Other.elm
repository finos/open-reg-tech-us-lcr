...
applyRules : Other -> List RuleFlow
applyRules flow =
    List.concat
        [ applyRule (match_rule_15_section_32_a_5 flow) (RuleFlow "32(a)(5)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_18_section_32_b flow) (RuleFlow "32(b)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_19_section_32_c flow) (RuleFlow "32(c)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_20_section_32_d flow) (RuleFlow "32(d)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_21_section_32_e_1_i flow) (RuleFlow "32(e)(1)(i)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_22_section_32_e_1_ii flow) (RuleFlow "32(e)(1)(ii)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_23_section_32_e_1_iii flow) (RuleFlow "32(e)(1)(iii)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_24_section_32_e_1_iv flow) (RuleFlow "32(e)(1)(iv)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_25_section_32_e_1_v flow) (RuleFlow "32(e)(1)(v)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_26_section_32_e_1_v flow) (RuleFlow "32(e)(1)(v)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_27_section_32_e_1_vi flow) (RuleFlow "32(e)(1)(vi)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_28_section_32_e_1_vii flow) (RuleFlow "32(e)(1)(vii)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_29_section_32_e_1_viii flow) (RuleFlow "32(e)(1)(viii)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_30_section_32_e_1_ix flow) (RuleFlow "32(e)(1)(ix)" (note_4 flow.collateralClass flow.collateralValue flow.maturityAmount) (OutOther flow))
        , applyRule (match_rule_31_section_32_f_1 flow) (RuleFlow "32(f)(1)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_32_section_32_f_1 flow) (RuleFlow "32(f)(1)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_34_section_32_f_3 flow) (RuleFlow "32(f)(3)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_101_section_32_l flow) (RuleFlow "32(l)" flow.maturityAmount (OutOther flow))
        , applyRule (match_rule_102_section_32_l flow) (RuleFlow "32(l)" flow.maturityAmount (OutOther flow))
        ]
