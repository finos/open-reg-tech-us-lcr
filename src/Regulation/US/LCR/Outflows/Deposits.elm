...
applyRules : Deposits -> List RuleFlow
applyRules flow =
    List.concat
        [ applyRule (match_rule_10_section_32_a_1 flow) (RuleFlow "32(a)(1)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_11_section_32_a_2 flow) (RuleFlow "32(a)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_12_section_32_a_3 flow) (RuleFlow "32(a)(3)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_13_section_32_a_4 flow) (RuleFlow "32(a)(4)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_14_section_32_a_5 flow) (RuleFlow "32(a)(5)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_39_section_32_g_1 flow) (RuleFlow "32(g)(1)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_40_section_32_g_2 flow) (RuleFlow "32(g)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_41_section_32_g_3 flow) (RuleFlow "32(g)(3)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_42_section_32_g_4 flow) (RuleFlow "32(g)(4)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_43_section_32_g_5 flow) (RuleFlow "32(g)(5)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_44_section_32_g_6 flow) (RuleFlow "32(g)(6)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_45_section_32_g_7 flow) (RuleFlow "32(g)(7)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_46_section_32_g_8 flow) (RuleFlow "32(g)(8)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_47_section_32_g_9 flow) (RuleFlow "32(g)(9)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_48_section_32_h_1_i flow) (RuleFlow "32(h)(1)(i)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_49_section_32_h_1_ii_A flow) (RuleFlow "32(h)(1)(ii)(A)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_52_section_32_h_1_ii_B flow) (RuleFlow "32(h)(1)(ii)(B)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_53_section_32_h_2 flow) (RuleFlow "32(h)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_57_section_32_h_3 flow) (RuleFlow "32(h)(3)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_58_section_32_h_4 flow) (RuleFlow "32(h)(4)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_59_section_32_h_4 flow) (RuleFlow "32(h)(4)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_60_section_32_h_5 flow) (RuleFlow "32(h)(5)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_64_section_32_j_1_i flow) (RuleFlow "32(j)(1)(i)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_67_section_32_j_1_ii flow) (RuleFlow "32(j)(1)(ii)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_70_section_32_j_1_iii flow) (RuleFlow "32(j)(1)(iii)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_72_section_32_j_1_iv flow) (RuleFlow "32(j)(1)(iv)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_73_section_32_j_1_iv flow) (RuleFlow "32(j)(1)(iv)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_77_section_32_j_1_vi flow) (RuleFlow "32(j)(1)(vi)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_78_section_32_j_1_vi flow) (RuleFlow "32(j)(1)(vi)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_81_section_32_j_2 flow) (RuleFlow "32(j)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_83_section_32_j_2 flow) (RuleFlow "32(j)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_84_section_32_j_2 flow) (RuleFlow "32(j)(2)" flow.maturityAmount (Deposit flow))
        , applyRule (match_rule_98_section_32_k flow) (RuleFlow "32(k)" flow.maturityAmount (Deposit flow))
        ]
...
match_rule_83_section_32_j_2 flow =
    List.member flow.product [ o_D_4 ]
        ...
        && (if Insured.isFDICInsured flow.insured then
