...
applyRules flow =
    List.concat
        [ applyRule (match_rule_8_section_21_b_todo flow) (RuleFlow "21(b)(todo)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_16_section_32_a_5 flow) (RuleFlow "32(a)(5)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_51_section_32_h_1_ii_A flow) (RuleFlow "32(h)(1)(ii)(A)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_55_section_32_h_2 flow) (RuleFlow "32(h)(2)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_65_section_32_j_1_i flow) (RuleFlow "32(j)(1)(i)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_68_section_32_j_1_ii flow) (RuleFlow "32(j)(1)(ii)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_71_section_32_j_1_iii flow) (RuleFlow "32(j)(1)(iii)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_74_section_32_j_1_iv flow) (RuleFlow "32(j)(1)(iv)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_76_section_32_j_1_v flow) (RuleFlow "32(j)(1)(v)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_79_section_32_j_1_vi flow) (RuleFlow "32(j)(1)(vi)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_82_section_32_j_2 flow) (RuleFlow "32(j)(2)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_99_section_32_k flow) (RuleFlow "32(k)" flow.maturityAmount (OutSecured flow))
        , applyRule (match_rule_100_section_32_k flow) (RuleFlow "32(k)" flow.maturityAmount (OutSecured flow))
        ]
