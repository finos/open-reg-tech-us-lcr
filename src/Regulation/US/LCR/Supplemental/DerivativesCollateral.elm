...
applyRules : DerivativesCollateral -> List RuleFlow
applyRules flow =
    List.concat
        [ applyRule (match_rule_3_section_20_a_1_C flow) (RuleFlow "20(a)(1)C" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_3_section_20_a_1 flow) (RuleFlow "20(a)(1)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_3_section_20_b_1 flow) (RuleFlow "20(b)(1)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_3_section_20_c_1 flow) (RuleFlow "20(c)(1)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_6_section_22_b_5_L1 flow) (RuleFlow "22(b)(5)L1" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_6_section_22_b_5_L2a flow) (RuleFlow "22(b)(5)L2a" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_6_section_22_b_5_L2b flow) (RuleFlow "22(b)(5)L2b" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_33_section_32_f_2 flow) (RuleFlow "32(f)(2)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_35_section_32_f_4 flow) (RuleFlow "32(f)(4)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_36_section_32_f_4 flow) (RuleFlow "32(f)(4)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_37_section_32_f_5 flow) (RuleFlow "32(f)(5)" flow.marketValue (Flow.DerivativesCollateral flow))
        , applyRule (match_rule_38_section_32_f_6 flow) (RuleFlow "32(f)(6)" flow.marketValue (Flow.DerivativesCollateral flow))
        ]
