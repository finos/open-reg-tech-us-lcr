...
applyRules flow =
    List.concat
        [ applyRule (match_rule_1_section_20_a_1_C flow) "33(c)" flow.marketValue
        , applyRule (match_rule_1_section_20_a_1 flow) "33(d)(1)" flow.marketValue
        , applyRule (match_rule_1_section_20_b_1 flow) "33(d)(2)" flow.marketValue
        , applyRule (match_rule_1_section_20_c_1 flow) "33(d)(2)" flow.marketValue
        , applyRule (match_rule_107_section_33_d_1 flow) "33(d)(2)" flow.marketValue
        ]
