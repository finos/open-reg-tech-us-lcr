...
applyRules : Secured -> List RuleFlow
applyRules flow =
    List.concat
        [ applyRule (match_rule_2_section_20_a_1 flow) (RuleFlow "20(a)(1)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_2_section_20_b_1 flow) (RuleFlow "20(b)(1)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_2_section_20_c_1 flow) (RuleFlow "20(c)(1)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_7_section_21_a_todo flow) (RuleFlow "21(a)(todo)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_9_section_21_c_todo flow) (RuleFlow "21(c)(todo)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_85_section_32_j_3_i flow) (RuleFlow "32(j)(3)(i)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_86_section_32_j_3_ii flow) (RuleFlow "32(j)(3)(ii)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_87_section_32_j_3_iii flow) (RuleFlow "32(j)(3)(iii)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_88_section_32_j_3_iv flow) (RuleFlow "32(j)(3)(iv)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_89_section_32_j_3_v flow) (RuleFlow "32(j)(3)(v)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_90_section_32_j_3_vi flow) (RuleFlow "32(j)(3)(vi)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_91_section_32_j_3_vii flow) (RuleFlow "32(j)(3)(vii)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_92_section_32_j_3_viii flow) (RuleFlow "32(j)(3)(viii)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_93_section_32_j_3_ix flow) (RuleFlow "32(j)(3)(ix)" flow.collateralValue (InfSecured flow))
        , applyRule (match_rule_94_section_32_j_3_x flow) (RuleFlow "32(j)(3)(x)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_95_section_32_j_3_xi flow) (RuleFlow "32(j)(3)(xi)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_96_section_32_j_3_xii flow) (RuleFlow "32(j)(3)(xii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_97_section_32_j_3_xiii flow) (RuleFlow "32(j)(3)(xiii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_105_section_33_c flow) (RuleFlow "33(c)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_108_section_33_d_1 flow) (RuleFlow "33(d)(1)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_110_section_33_d_2 flow) (RuleFlow "33(d)(2)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_113_section_33_f_1_i flow) (RuleFlow "33(f)(1)(i)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_114_section_33_f_1_ii flow) (RuleFlow "33(f)(1)(ii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_115_section_33_f_1_ii flow) (RuleFlow "33(f)(1)(ii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_116_section_33_f_1_ii flow) (RuleFlow "33(f)(1)(ii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_117_section_33_f_1_iii flow) (RuleFlow "33(f)(1)(iii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_118_section_33_f_1_iii flow) (RuleFlow "33(f)(1)(iii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_119_section_33_f_1_iv flow) (RuleFlow "33(f)(1)(iv)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_120_section_33_f_1_iv flow) (RuleFlow "33(f)(1)(iv)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_121_section_33_f_1_v flow) (RuleFlow "33(f)(1)(v)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_122_section_33_f_1_v flow) (RuleFlow "33(f)(1)(v)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_123_section_33_f_1_vi flow) (RuleFlow "33(f)(1)(vi)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_124_section_33_f_1_vii flow) (RuleFlow "33(f)(1)(vii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_125_section_33_f_2_i flow) (RuleFlow "33(f)(2)(i)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_126_section_33_f_2_ii flow) (RuleFlow "33(f)(2)(ii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_127_section_33_f_2_iii flow) (RuleFlow "33(f)(2)(iii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_128_section_33_f_2_iv flow) (RuleFlow "33(f)(2)(iv)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_129_section_33_f_2_v flow) (RuleFlow "33(f)(2)(v)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_130_section_33_f_2_vi flow) (RuleFlow "33(f)(2)(vi)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_131_section_33_f_2_vii flow) (RuleFlow "33(f)(2)(vii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_132_section_33_f_2_viii flow) (RuleFlow "33(f)(2)(viii)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_133_section_33_f_2_ix flow) (RuleFlow "33(f)(2)(ix)" flow.maturityAmount (InfSecured flow))
        , applyRule (match_rule_134_section_33_f_2_x flow) (RuleFlow "33(f)(2)(x)" flow.maturityAmount (InfSecured flow))
        ]
