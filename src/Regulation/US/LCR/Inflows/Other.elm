...
applyRules flow =
    List.concat
        [ applyRule (match_rule_103_section_33_b flow) (RuleFlow "33(b)" flow.maturityAmount (InfOther flow))
        , applyRule (match_rule_111_section_33_e flow) (RuleFlow "33(e)" flow.maturityAmount (InfOther flow))
        , applyRule (match_rule_112_section_33_e flow) (RuleFlow "33(e)" flow.maturityAmount (InfOther flow))
        , applyRule (match_rule_135_section_33_g flow) (RuleFlow "33(g)" flow.maturityAmount (InfOther flow))
        , applyRule (match_rule_136_section_33_h flow) (RuleFlow "33(h)" flow.maturityAmount (InfOther flow))
        ]
